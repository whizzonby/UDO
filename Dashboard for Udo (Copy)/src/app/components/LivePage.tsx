        ...
        {activeTab === 'today' && (
          <div className="space-y-6">
            ...
            >
              ...
              <div className="space-y-3">
                {[
                  { message: 'Guests notified of ceremony start', time: '15 min ago' },
                  { message: 'Reminder sent to wedding party', time: '42 min ago' },
                ].map((update, idx) => (
                  <div key={idx} className="p-3 bg-[#F3EFEA] rounded-[16px]">
                    <div className="text-[13px] text-[#2B2B2B] mb-1">{update.message}</div>
                    <div className="text-[11px] text-[#6F6F6F]">{update.time}</div>
                  </div>
                ))}
              </div>
            </button>
          ...
          <div className="space-y-4">
            <div className="bg-white rounded-2xl p-5 shadow-[0_4px_12px_rgba(0,0,0,0.04)] border border-[#EAE7E2]">
              ...
              <textarea
                ...
                rows={4}
              />
              <button className="w-full bg-[#3A8B95] text-white py-3 rounded-[20px] text-[14px] mt-3 hover:bg-[#3A7D6D] transition-colors" style={{ fontWeight: 500 }}>
                Send to all guests
              </button>
            </div>
            ...
            <div className="bg-white rounded-2xl p-5 shadow-[0_4px_12px_rgba(0,0,0,0.04)] border border-[#EAE7E2]">
              ...
              <div className="space-y-3">
                {[
                  { time: '15 min ago', message: 'Ceremony starting in 15 minutes — please find your seats' },
                  { time: '42 min ago', message: "Welcome everyone! We're so happy you're here" },
                  { time: '1 hour ago', message: 'Reminder: Cocktails will be served on the terrace' },
                ].map((update, idx) => (
                  <div key={idx} className="p-4 bg-[#F3EFEA] rounded-[20px]">
                    <div className="text-[11px] text-[#6F6F6F] mb-2">{update.time}</div>
                    <div className="text-[13px] text-[#2B2B2B]" style={{ lineHeight: 1.5 }}>{update.message}</div>
                  </div>
                ))}
              </div>
            </div>
