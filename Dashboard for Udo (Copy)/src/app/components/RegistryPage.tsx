...
import { Gift, Link2, List, Heart, Share2, Plus, X, Check, ExternalLink, Calendar, MapPin, Clock, Sparkles, CheckCircle, MessageSquare } from 'lucide-react';
...
export default function RegistryPage() {
  ...
  const [registryItems] = useState<RegistryItem[]>([
    { id: 1, type: 'link', title: 'Espresso Machine', price: '$299', status: 'gifted', image: '' },
    { id: 2, type: 'custom', title: 'Kitchen Aid Mixer', price: '$379', status: 'reserved' },
    { id: 3, type: 'link', title: 'Linen Bedding Set', price: '$189', status: 'available', image: '' },
    { id: 4, type: 'custom', title: 'Garden Tools Set', price: '$120', status: 'available' },
  ]);

  const [thankYouItems] = useState<ThankYouItem[]>([
    { id: 1, guestName: 'Sarah Martinez', gift: 'Espresso Machine', status: 'pending' },
    { id: 2, guestName: 'James Chen', gift: 'Monetary gift - $150', status: 'pending' },
    { id: 3, guestName: 'Emma Wilson', gift: 'Honeymoon contribution', status: 'pending' },
    { id: 4, guestName: 'Michael Brown', gift: 'Kitchen Aid Mixer', status: 'completed', dateThanked: 'April 2, 2026', message: 'Thank you so much for the beautiful mixer...' },
    { id: 5, guestName: 'Jessica Lee', gift: 'Monetary gift - $200', status: 'completed', dateThanked: 'April 1, 2026' },
  ]);
