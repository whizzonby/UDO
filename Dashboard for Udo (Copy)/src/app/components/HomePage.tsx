    ...
    <div className="min-h-screen bg-[#FAFAFA]">
      ...
      <div className="bg-gradient-to-br from-[#FF88BA] to-[#FF3E9B] px-5 pt-10 pb-8 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/90 text-[15px]">June 14, 2026 • San Diego, CA</p>
        </div>
      </div>
          ...
          <div className="space-y-4">
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="text-[13px] text-gray-500">64%</span>
              </div>
            ...
            <div className="grid grid-cols-3 gap-3 pt-2">
              <div className="text-center">
                <div className="text-[24px] font-semibold text-[#FF3E9B]">24</div>
                <div className="text-[11px] text-gray-500 mt-1">Done</div>
              </div>
              <div className="text-center">
                <div className="text-[24px] font-semibold text-[#3A8B95]">8</div>
                <div className="text-[11px] text-gray-500 mt-1">In progress</div>
              </div>
              <div className="text-center">
                <div className="text-[24px] font-semibold text-gray-400">5</div>
        ...
        >
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3 p-4 bg-[#F0F9FA] rounded-[16px] border border-[#3A8B95]/20">
              ...
              <div>
                <div className="text-[14px] font-medium text-gray-900">12 guests haven't RSVP'd</div>
                <div className="text-[12px] text-gray-500 mt-0.5">Deadline is in 8 days</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="flex justify-between text-[12px]">
                <span className="text-gray-500">$6,600 remaining</span>
                <span className="text-gray-500">81% used</span>
              </div>
            </div>

            <div className="grid grid-cols-2 gap-3 pt-2">
              <div className="p-3 bg-[#FAFAFA] rounded-[12px]">
                <div className="text-[11px] text-gray-500 mb-1">Top spend</div>
                <div className="text-[15px] font-semibold text-gray-900">Venue</div>
                <div className="text-[12px] text-gray-600 mt-0.5">$12,000</div>
              </div>
              <div className="p-3 bg-[#FAFAFA] rounded-[12px]">
                <div className="text-[11px] text-gray-500 mb-1">Pending</div>
                <div className="text-[15px] font-semibold text-gray-900">3 deposits</div>
                <div className="text-[12px] text-gray-600 mt-0.5">$3,400 due</div>
              </div>
            </div>
          </div>
        </div>
