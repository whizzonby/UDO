You are right. The earlier versions still left too much room for interpretation.

Below is a **rewritten, page-by-page, long-form Figma prompt** written the way you asked: **each page gets its own section, each section gets detailed paragraph instructions, and each major sub-section explains exactly what should appear, how it should look, what it should say, and what every button should do.**

This is intentionally wordy so the builder has far less room to freestyle.
...
If you want, I can do the same thing in this exact dense format for the **Live** section next.
