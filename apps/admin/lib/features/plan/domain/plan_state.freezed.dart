...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  loading,TResult Function( PlanData data)?  loaded,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Loading() when loading != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  loading,required TResult Function( PlanData data)  loaded,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case _Loading():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  loading,TResult? Function( PlanData data)?  loaded,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case _Loading() when loading != null:
return loading();case _Loaded() when loaded != null:
return loaded(_that.data);case _Error() when error != null:
...
class _Loaded implements PlanState {
...
@override
String toString() {
  return 'PlanState.loaded(data: $data)';
}
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $PlanStateCopyWith<$Res> {
...
$PlanDataCopyWith<$Res> get data {
  ...
  return $PlanDataCopyWith<$Res>(_self.data, (value) {
