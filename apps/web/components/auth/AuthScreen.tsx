    ...
    <div className="min-h-screen bg-[#f8edeb] flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-serif text-[#285301] mb-3" style={{ fontFamily: 'Playfair Display, serif' }}>
            UDO
          </h1>
        ...
        <div className="bg-white rounded-3xl shadow-lg p-8 space-y-6">
          <div className="flex gap-3 bg-[#f8edeb] p-1.5 rounded-2xl">
            <button
              ...
              className={`flex-1 py-2.5 rounded-xl text-sm font-medium transition-all ${
                !isSignUp ? 'bg-white text-[#285301] shadow-sm' : 'text-gray-600'
              }`}
            >
              Sign in
            </button>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-[#285301] text-white py-3.5 rounded-xl font-medium hover:bg-[#1f4001] transition-colors"
            >
          ...
          {!isSignUp && (
            <div className="text-center">
              <button className="text-sm text-[#d45d78] hover:underline">Forgot password?</button>
            </div>
          )}
