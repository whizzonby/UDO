...
class CoreEventArchitecturePage extends StatelessWidget {
  ...
  const CoreEventArchitecturePage(
      {super.key,
  ...
  Widget build(BuildContext context) {
    return OnboardingScaffold(
      ...
      preamble:
          'This section helps us understand the structure, setting, and feeling of your celebration.',
      ...
      child: Column(
        ...
        children: [
          OnboardingSection(
              title: 'Wedding type',
              child: _GridPicker(
                  options: kWeddingTypes,
                  selected: answers.weddingType,
                  onSelect: (v) => setState(() => answers.weddingType = v))),
          OnboardingSection(
              title: 'Season',
              child: _GridPicker(
                  options: kSeasons,
                  selected: answers.season,
                  onSelect: (v) => setState(() => answers.season = v))),
          OnboardingSection(
            title: 'Date',
            child: Column(
              children: [
                _GridPicker(
                    options: kDateStatuses,
                    selected: answers.dateStatus,
                    onSelect: (v) => setState(() => answers.dateStatus = v)),
                  ...
                  GestureDetector(
                    onTap: () async {
                      final d = await showDatePicker(
                        context: context,
                        initialDate: answers.weddingDate ??
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(
                            answers.weddingDate == null
                                ? 'Enter your wedding date'
                                : '${answers.weddingDate!.day}/${answers.weddingDate!.month}/${answers.weddingDate!.year}',
                            style: TextStyle(
                                color: answers.weddingDate == null
          ...
          OnboardingSection(
              ...
              child: _GridPicker(
                  options: kTimesOfDay,
                  selected: answers.timeOfDay,
                  onSelect: (v) => setState(() => answers.timeOfDay = v))),
          OnboardingSection(
            ...
            child: MultiSelectChips(
              ...
              onToggle: (v) =>
                  setState(() => answers.toggle(answers.eventStructure, v)),
            ),
          ),
        ],
      ),
...
class LocationTravelPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return OnboardingScaffold(
      ...
      preamble:
          'This helps us plan around venue progress, travel needs, and guest coordination.',
      currentStep: 5,
      totalSteps: 24,
      onNext: onNext,
      onBack: onBack,
            ...
            child: Column(
              children: [
                UdoTextField(
                    label: 'Country',
                    hint: 'Enter country',
                    onChanged: (v) => answers.country = v),
                const SizedBox(height: 12),
                UdoTextField(
                    label: 'City',
                    hint: 'Enter city',
                    onChanged: (v) => answers.city = v),
              ],
            ),
          ),
          OnboardingSection(
              ...
              children: kVenueStatuses
                  .map((s) => Padding(
                        ...
                        child: SelectableCard(
                            label: s,
                            selected: answers.venueStatus == s,
                            onTap: () =>
                                setState(() => answers.venueStatus = s),
                            dense: true),
                      ))
                  .toList(),
            ),
            ...
            child: Column(
              children: kGuestTravelOptions
                  .map((s) => Padding(
                        ...
                        child: SelectableCard(
                            label: s,
                            selected: answers.guestTravel == s,
                            onTap: () =>
                                setState(() => answers.guestTravel = s),
                            dense: true),
                      ))
                  .toList(),
            ),
...
class GuestExperiencePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return OnboardingScaffold(
      title: 'Design your guest portal',
      preamble:
          'The choices you make here will shape your guest portal, communications, reminders, and planning recommendations.',
      quote:
          'Think about how you want guests to feel from the moment they are invited.',
      currentStep: 6,
      totalSteps: 24,
      onNext: onNext,
      onBack: onBack,
      ...
      child: Column(
        ...
        children: [
          ...
          MultiSelectChips(
            ...
            onToggle: (v) =>
                setState(() => answers.toggle(answers.guestExperience, v)),
          ),
          const SizedBox(height: 16),
          Container(
            width: double.infinity,
          ...
          Text('Expected guest count: ${answers.guestCount}',
...
const kBudgetStructures = [
  'Fixed budget',
  'Flexible budget',
  'Priority-led budget'
];
const kAllocationPreferences = [
  'Even distribution',
  'Experience-focused',
  'Aesthetic-focused',
  'Cost-conscious / controlled',
  'Luxury-led',
  'Logistics-first'
];
const kFundingOptions = [
  'Self-funded',
  'Family-funded',
  'Joint contributions',
  'Shared support from multiple people',
  'Prefer not to say'
];
const kBudgetConfidences = [
  'Early estimate',
  'Moderately defined',
  'Finalised'
];
...
class BudgetPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return OnboardingScaffold(
      ...
      preamble:
          'We are not just asking how much you want to spend — we are learning how you want to spend it.',
      currentStep: 7,
      totalSteps: 24,
      onNext: onNext,
      onBack: onBack,
        ...
        children: [
            ...
            child: Column(
              children: kBudgetStructures
                  .map((s) => Padding(
                      ...
                      child: SelectableCard(
                          label: s,
                          selected: answers.budgetStructure == s,
                          onTap: () =>
                              setState(() => answers.budgetStructure = s),
                          dense: true)))
                  .toList(),
            ),
          ),
          OnboardingSection(
            ...
            child: GridView.count(
              ...
              children: kAllocationPreferences
                  .map((p) => SelectableCard(
                      label: p,
                      selected: answers.allocationPreference == p,
                      onTap: () =>
                          setState(() => answers.allocationPreference = p),
                      dense: true,
                      centered: true))
                  .toList(),
            ),
          ...
          OnboardingSection(
            title: 'Funding',
            helper:
                'Understanding who is contributing helps us frame planning conversations realistically.',
            child: Column(
              children: kFundingOptions
                  .map((f) => Padding(
                      ...
                      child: SelectableCard(
                          label: f,
                          selected: answers.funding == f,
                          onTap: () => setState(() => answers.funding = f),
                          dense: true)))
                  .toList(),
            ),
          ),
          OnboardingSection(
            title: 'Confidence',
            helper:
                'Confidence shows how certain you feel about your current budget choices.',
            child: Column(
              children: kBudgetConfidences
                  .map((c) => Padding(
                      ...
                      child: SelectableCard(
                          label: c,
                          selected: answers.budgetConfidence == c,
                          onTap: () =>
                              setState(() => answers.budgetConfidence = c),
                          dense: true)))
                  .toList(),
            ),
          ),
...
class PrioritiesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return OnboardingScaffold(
      ...
      preamble:
          'We really want to know what makes you light up. Your priorities will help us guide you beautifully.',
      ...
      child: Column(
        ...
        children: [
          ...
          MultiSelectChips(
            ...
            maxSelections: 5,
            onToggle: (v) =>
                setState(() => answers.toggle(answers.priorities, v, max: 5)),
          ),
        ],
      ),
    );
